  ...
  var __webpack_modules__ = {
      ...
      6993(e, t, r) {
        ...
        async function c(e, t = !0, r = a.PinExpiryDurationOption.SevenDays) {
          ...
          const m = await (0, u.getMessageById)(e),
            ...
            b = i.PinInChatStore.getByParentMsgKey(m.id);
          if (y.isNewsletter)
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
          ...
          if (b && b.pinType === (t ? a.PIN_STATE.PIN : a.PIN_STATE.UNPIN))
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
      ...
      22418(e, t, r) {
        ...
        const u = r(91491),
          ...
          l = r(13691),
          d = r(26738);
        (s(r(26738), t), (t.waVersion = "3.20.1"));
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      if (((M = R.width), (O = R.height), h)) {
                        ...
                        var D = x({ aspectRatio: j, width: S, height: I }),
                          F = D.width;
                        S = void 0 === F ? r : F;
                        var U = D.height;
                        I = void 0 === U ? n : U;
                      ...
                      ((m.width = S),
                        (m.height = I),
                        v(p.mimeType) || (p.mimeType = d.type));
                      var Z = "transparent";
                      ...
                      if (
                        ...
                        !this.aborted &&
                          ...
                          y.scale(s, c),
                          y.drawImage.apply(y, [f].concat(V)),
                          y.restore(),
                      ...
                      if (
                        ...
                        if (
                          ...
                          ((n.lastModified = s.getTime()),
                            ...
                            n.name &&
                              n.type !== o.type &&
                              (n.name = n.name.replace(B, h(n.type))));
                        }
                      else n = o;
      ...
      24654(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendFileMessage = async function (e, t, r) {
            ...
            let a;
            ((r = Object.assign(
              Object.assign(Object.assign({}, v.defaultSendMessageOptions), {
                type: "auto-detect",
                waveform: !0,
              }),
              r,
              ...
              (a =
                "status@broadcast" == (null == e ? void 0 : e.toString())
                  ? new g.ChatModel({ id: (0, l.createWid)(b.STATUS_JID) })
                  : await (0, c.assertFindChat)(e)));
            const s = await (0, l.convertToFile)(t, r.mimetype, r.filename),
              u = s.name,
              f = (0, d.getMediaTypeForValidation)(r.type, s.type),
              y = "status@broadcast" === (null == e ? void 0 : e.toString());
            try {
              const e = y ? "STATUS_TAB_CAMERA_PHOTO_LIBRARY" : null,
                t = p.MediaGatingUtils.getUploadLimit(f, e);
              if (
                (P(
                  `Validating file size: ${s.size} bytes, limit for ${f}: ${t} bytes`,
                ),
                s.size > t)
              )
                throw new l.WPPError(
                  "file_too_large",
                  `File size ${(0, d.formatFileSize)(s.size)} exceeds the upload limit of ${(0, d.formatFileSize)(t)} for ${f} files`,
                  { fileSize: s.size, limit: t, mediaType: f },
                );
            } catch (e) {
              if (e instanceof l.WPPError) throw e;
            }
            ...
            function A(e, t) {
              P(`message file ${E.id} is ${t}`);
            }
            if (
              (P(`message file ${E.id} queued`),
              E.on("change:mediaData.mediaStage", A),
              I.finally(() => {
                E.off("change:mediaData.mediaStage", A);
              }),
              "status@broadcast" !== e)
            ) {
              if (r.waitForAck) {
                P(`waiting ack for ${E.id}`);
                const e = await I;
                P(
                  `ack received for ${E.id} (ACK: ${E.ack}, SendResult: ${JSON.stringify(e)})`,
                );
              }
              return {
            ...
            }
            {
              const e = await new Promise((e, t) => {
                const r = setTimeout(() => {
                  ...
                  n = setInterval(async () => {
                    const t = await (0, h.getMessageById)(E.id);
        ...
        f.onFullReady(() => {
          ((0, y.wrapModuleFunction)(
            ...
            (0, y.wrapModuleFunction)(b.processRawSticker, async (e, ...t) => {
              const [r] = t,
                n = await e(...t);
              if ("image/webp" === r.type()) {
                const e = r.forceToBlob(),
                  t = await (0, l.blobToArrayBuffer)(e);
                (0, b.isAnimatedWebp)(t) &&
            ...
            (0, y.wrapModuleFunction)(b.uploadMedia, async (e, ...t) => {
              const [r] = t;
      ...
      36618(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.find = async function (e) {
            const t = (0, n.assertWid)(e),
              { chat: r } = await (0, i.findOrCreateLatestChat)(
                t,
                "newChatFlow",
              );
      ...
      38385(e, t, r) {
        ...
        const n =
          ...
          g = (e, t) => {
            ...
            const v = b.findIndex((e) => "0" !== e) + 1,
              h = "~" === n ? 2 : v > 1 ? v : 1;
            return (
              0 === u(y.slice(0, h), b.slice(0, h)) &&
              -1 !== u(y.slice(h), b.slice(h))
            );
          },
      ...
      48769(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessages = async function (e, t = {}) {
            ...
            !t.id && d && c--;
            const f = d ? i.MsgKey.fromString(d) : { remote: u.id };
            ((f.count = c), (f.direction = l));
            let p = [];
            if ("all" === t.media) {
              const { messages: e } = await (0, s.msgFindQuery)("media", f);
              Array.isArray(e) && p.push(...e);
              ...
              const { messages: e } = await (0, s.msgFindQuery)("media", f);
              Array.isArray(e) && p.push(...e);
            } else p = await (0, s.msgFindQuery)(l, f);
            if (!t.id && d) {
            ...
            if (
              ...
              try {
                const e = await (0, s.msgFindQuery)(a.MSG_TYPE.CALL_LOG, f);
                if (e && e.length > 0) {
                  const t = e.map((e) =>
                    e instanceof i.MsgModel
                      ? e
      ...
      51464(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatFromUnread = async function (e, t) {
            const r = (0, n.assertWid)(e),
              { chat: s } = await (0, a.findOrCreateLatestChat)(
                r,
                "newChatFlow",
              );
            if ((0, o.isWhatsAppVersionLTE)("2.3000.1029960097"))
              return await i.Cmd.openChatFromUnread(s);
        ...
        !(function (o) {
          ...
          function j(e, t, r, n, o) {
            ...
            if (((g = r["*"]) && j(e, t, g, n + 1, o), (m = r["**"])))
              if (n < o)
                for (
                  m._listeners && j(e, t, m, o, o), s = (v = d(m)).length;
                  s-- > 0;
                )
                  "_listeners" !== (p = v[s]) &&
                    (p === M
      ...
      53141(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.queryExists = async function (e) {
            var t, r, n, o, i;
            const a = (0, s.assertWid)(e),
              f = `+${a.toString()}`;
            if (d.has(f)) return d.get(f);
            const p = new c.USyncUser(),
              g = new c.USyncQuery();
            if (a.isLid()) p.withId(a);
            else if (
              (g.withContactProtocol(),
              p.withPhone(f.replace("@c.us", "")),
              a.isUser())
            ) {
              const e = c.ApiContact.getCurrentLid(
            ...
            g.withUser(p)
              ...
              .withStatusProtocol()
              .withLidProtocol();
            const m = await g.execute();
            let y = null;
            ((null === (t = null == m ? void 0 : m.error) || void 0 === t
              ? void 0
              : t.all) ||
              (null === (r = null == m ? void 0 : m.error) || void 0 === r
                ? void 0
                : r.contact)) &&
              (y = null);
            if (Array.isArray(m.list))
              if (
                ((y = m.list[0]),
                "out" ===
                  (null === (n = null == y ? void 0 : y.contact) || void 0 === n
                    ? void 0
                    : n.type))
              )
                y = null;
              else {
                const e = null == y ? void 0 : y.lid;
                ((y = {
                  wid: y.id,
                  biz: void 0 !== y.business,
                  bizInfo: y.business,
                  disappearingMode:
                    void 0 !== y.disappearing_mode
                      ? {
                          duration:
                            null === (o = y.disappearing_mode) || void 0 === o
                              ? void 0
                              : o.duration,
                          settingTimestamp:
                            null === (i = y.disappearing_mode) || void 0 === i
                              ? void 0
                              : i.t,
                        }
                      : void 0,
                  status: y.status,
                  lid: e ? (0, u.createWid)(e) : void 0,
                }),
                  y.lid &&
                    a.isUser() &&
                    !a.isLid() &&
                    (await l.createLidPnMappings({
                      mappings: [{ lid: y.lid, pn: y.wid }],
                      flushImmediately: !0,
      ...
      60397(e, t, r) {
        ...
        (Object.defineProperty(t, "markAvailable", {
          enumerable: !0,
          get: function () {
            return j.markAvailable;
          },
        }),
          Object.defineProperty(t, "markUnavailable", {
            enumerable: !0,
            get: function () {
              return j.markUnavailable;
            },
          }));
        var S = r(12709);
        ...
        Object.defineProperty(t, "setAutoDownloadSettings", {
          enumerable: !0,
          get: function () {
            return x.setAutoDownloadSettings;
          },
        });
        var I = r(22987);
        ...
        (s.onFullReady(function () {
          ((0, c.wrapModuleFunction)(l.mediaTypeFromProtobuf, (e, ...t) => {
            ...
            (0, c.wrapModuleFunction)(l.findChat, async (e, ...t) => {
              const [r, n] = t;
              if (!r.isLid()) return await e(...t);
              const o = u.ContactStore.get(r);
              if (!(await (0, l.getExisting)(r)) && o) {
                const o = new Set([
                    "username_change_notification",
                    "username_contactless_search",
                  ]),
                  i = d.ApiContact.getPhoneNumber(r);
                if (o.has(n) && null != i) return await (0, l.findChat)(i, n);
                const a = { chatId: r };
                return (
            ...
            (0, c.wrapModuleFunction)(l.getEnforceCurrentLid, (e, ...t) => {
              const [r] = t;
              try {
                return (l.toUserLid ? (0, l.toUserLid)(r) : null) || r;
              } catch (e) {
                return r;
              }
            }),
      ...
      74212(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatBottom = async function (e, t) {
            ...
            if ((0, o.isWhatsAppVersionLTE)("2.3000.1029960097"))
              return await i.Cmd.openChatBottom(s, t);
            return await i.Cmd.openChatBottom({ chat: s, chatEntryPoint: t });
          }));
        const n = r(41687),
          o = r(64120),
          i = r(14647),
            ...
            l.CallStore.on("add", (e) => {
              e.isGroup &&
                s.internalEv.emit("call.incoming_call", {
                  ...
                  sender: (0, u.createWid)(e.peerJid),
                  peerJid: e.peerJid,
                });
            }),
            void l.CallStore.on("change", (e) => {
              (e.getState() !== d.CALL_STATES.INCOMING_RING &&
                e.getState() !== d.CALL_STATES.ReceivedCall) ||
                s.internalEv.emit("call.incoming_call", {
                  id: e.id,
                  isGroup: e.isGroup,
                  isVideo: e.isVideo,
      ...
      78626(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.generateMessageID = async function (e) {
            ...
            if (r.isGroup()) {
              s = (
                (null === i.WidFactory || void 0 === i.WidFactory
                  ? void 0
                  : i.WidFactory.toUserWid) ||
                (null === i.WidFactory || void 0 === i.WidFactory
                  ? void 0
                  : i.WidFactory.toUserWidOrThrow) ||
                (null === i.WidFactory || void 0 === i.WidFactory
                  ? void 0
                  : i.WidFactory.createWid)
              )(t);
            }
            return new i.MsgKey({
              from: t,
      ...
      82349(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.offer = async function (e, t = {}) {
            ...
            const b = await a.websocket.sendSmaxStanza(m);
            return (
              console.info(b),
              console.info((0, c.parseRelayResponse)(b)),
              y
            );
          }));
        const n = r(41687),
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.save = async function (e, t, r) {
            ...
            if ((0, o.isWhatsAppVersionGTE)("2.3000.1030209354"))
              ...
              await (0, s.saveContactAction)(y, null, null, null, t, v, b);
            }
      ...
      91082(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatAt = async function (e, t, r) {
            ...
            try {
              const e = (0, i.getSearchContext)(u, c);
              return await o.Cmd.openChatAt(u, e);
            } catch (e) {
              const t = (0, i.getSearchContext)(u, c.id._serialized);
      ...
      97829(e, t, r) {
        ...
        Object.defineProperty(t, "prepareMessageButtons", {
          enumerable: !0,
          get: function () {
            return V.prepareMessageButtons;
          },
        });
        var $ = r(19211);
      ...
      98925(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          "UsernameGatingUtils",
          (e) =>
            e.usernameSupported && "function" == typeof e.usernameSupported,
        );
      },
      98927(e, t, r) {
        "use strict";
